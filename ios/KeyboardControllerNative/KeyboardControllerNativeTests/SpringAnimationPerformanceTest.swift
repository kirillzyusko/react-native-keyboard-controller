...
final class SpringAnimationPerformanceTest: XCTestCase {
  ...
  func testCriticallyDampedValueAt() {
  ...
  func testCriticallyDampedTimingAt() {
  ...
  func testCriticallyDampedValueAtPerformance() {
  ...
  func testCriticallyDampedTimingAtPerformance() {
    measure(metrics: [XCTCPUMetric(), XCTClockMetric()], options: options) {
