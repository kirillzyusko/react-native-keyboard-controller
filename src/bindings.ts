...
/**
 * A container that replaces the system keyboard with its children
 * whenever a text input becomes focused.
 */
export const RCTCustomKeyboardView =
  View as unknown as React.FC<CustomKeyboardProps>;
/**
