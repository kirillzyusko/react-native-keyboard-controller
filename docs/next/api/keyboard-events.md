...
## Event structure[​](/react-native-keyboard-controller/docs/next/api/keyboard-events.md#event-structure "Direct link to Event structure")
...
## Example[​](/react-native-keyboard-controller/docs/next/api/keyboard-events.md#example "Direct link to Example")
