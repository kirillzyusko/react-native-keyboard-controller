...
## Example[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#example "Direct link to Example")
...
### Event structure[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#event-structure "Direct link to Event structure")
...
### Handlers[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#handlers "Direct link to Handlers")

#### `onStart`[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#onstart "Direct link to onstart")
...
#### `onMove`[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#onmove "Direct link to onmove")
...
#### `onInteractive`[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#oninteractive "Direct link to oninteractive")
...
This event is available only on Android >= 11. To receive it you need to use [KeyboardGestureArea](/react-native-keyboard-controller/docs/next/api/keyboard-gesture-area.md).

On iOS you need to specify `keyboardDismissMode="interactive"` on your `ScrollView`.

#### `onEnd`[​](/react-native-keyboard-controller/docs/next/api/hooks/keyboard/use-keyboard-handler.md#onend "Direct link to onend")
