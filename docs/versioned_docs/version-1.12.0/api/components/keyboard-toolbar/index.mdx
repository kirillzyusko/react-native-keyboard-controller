...
```ts
import { DefaultKeyboardToolbarTheme, type KeyboardToolbarProps } from "react-native-keyboard-controller";
type KeyboardToolbarTheme = KeyboardToolbarProps["theme"]

const theme: KeyboardToolbarTheme = {
