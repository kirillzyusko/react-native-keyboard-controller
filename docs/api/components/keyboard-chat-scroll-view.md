...
### Reanimated feature flag[​](/react-native-keyboard-controller/docs/api/components/keyboard-chat-scroll-view.md#reanimated-feature-flag "Direct link to Reanimated feature flag")
