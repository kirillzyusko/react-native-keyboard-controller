...
<ComparisonTable
  left={<Image src="/img/keyboard-chat-translucent.png" width={65} />}
  right={<Image src="/img/keyboard-chat-non-translucent.png" width={65} />}
  leftText={
    <i>
      By default keyboard is transparent, messages behind the keyboard is
      visible (Messages app style)
    </i>
  }
  rightText={
    <i>
      Non-transparent keyboard, messages behind the keyboard are hidden
      (Instagram app style)
    </i>
  }
/>
