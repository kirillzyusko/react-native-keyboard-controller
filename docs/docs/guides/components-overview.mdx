...
If you are building a chat application, check out the dedicated [guide](./building-chat-app) guide that explores pitfalls of building chat app layout and shows how to solve them using `ChatKit` component.
:::
