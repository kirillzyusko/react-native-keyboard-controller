...
On Android < 11 values will not be perfectly synchronized with the keyboard, because prior to this version it was not possible to get keyboard position during an animation.
:::
