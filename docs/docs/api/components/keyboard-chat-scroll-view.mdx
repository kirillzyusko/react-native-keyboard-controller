...
- [react-native-reanimated#9000](https://github.com/software-mansion/react-native-reanimated/issues/9000): Android has undesired "bounce" animation effect on Fabric architecture
