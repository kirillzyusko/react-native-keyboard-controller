...
|AutoScroll when user types and input in non visible area|❌|❌|?|🟠 <sup><small>3</small></sup>|
|Android support|✅|✅|❌|✅|
|Maintained|✅|❌|✅|✅|
|Support Fabric (new) architecture|✅|🟠 <sup><small>4</small></sup>|❌|✅|

> <sup>1</sup> respects <b>only</b> on <b>iOS</b>

> <sup>2</sup> <code>KeyboardAwareScrollViewView</code> is implemented in JS, but some hooks (<code>useKeyboardHandler</code> and <code>useReanimatedFocusedInput</code>) exposed from native code

> <sup>3</sup> not implemented yet, but planned 😉
