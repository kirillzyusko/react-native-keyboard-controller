...
keywords: [react-native-keyboard-controller, interactive keyboard, swipe to dismiss keyboard, control keyboard position via gesture]
---
...
<Lottie src="img/interactive.lottie" style={{ width: 400, height: 400 }} />
</div>
