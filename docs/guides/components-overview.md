...
If you are building a chat application, check out the dedicated [guide](/react-native-keyboard-controller/docs/guides/building-chat-app.md) that explores pitfalls of building chat app layout and shows how to solve them using [`KeyboardChatScrollView`](/react-native-keyboard-controller/docs/api/components/keyboard-chat-scroll-view.md) component.
