...
## Setting up a mock[​](/react-native-keyboard-controller/pr-preview/pr-1029/docs/recipes/jest-testing-guide.md#setting-up-a-mock "Direct link to Setting up a mock")
...
## Test case example[​](/react-native-keyboard-controller/pr-preview/pr-1029/docs/recipes/jest-testing-guide.md#test-case-example "Direct link to Test case example")
