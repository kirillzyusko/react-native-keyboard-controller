...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-986/docs/next/api/over-keyboard-view.md#props "Direct link to Props")

### `visible`[​](/react-native-keyboard-controller/pr-preview/pr-986/docs/next/api/over-keyboard-view.md#visible "Direct link to visible")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-986/docs/next/api/over-keyboard-view.md#example "Direct link to Example")
