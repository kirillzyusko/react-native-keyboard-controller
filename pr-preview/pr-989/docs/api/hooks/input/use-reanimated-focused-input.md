...
## Event structure[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/input/use-reanimated-focused-input.md#event-structure "Direct link to Event structure")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/input/use-reanimated-focused-input.md#example "Direct link to Example")
