...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#example "Direct link to Example")
...
### Event structure[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#event-structure "Direct link to Event structure")
...
### Handlers[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#handlers "Direct link to Handlers")

#### `onStart`[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#onstart "Direct link to onstart")
...
![](/react-native-keyboard-controller/pr-preview/pr-989/assets/images/start-43926ae4afe7279da4f2fdd3d25603c6.png)
...
#### `onMove`[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#onmove "Direct link to onmove")
...
![](/react-native-keyboard-controller/pr-preview/pr-989/assets/images/move-67a142f62e5e7286e45c5e964d03b862.png)
...
#### `onInteractive`[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#oninteractive "Direct link to oninteractive")
...
![](/react-native-keyboard-controller/pr-preview/pr-989/assets/images/interactive-5613a4e3be3e96ff53479d7d9ab342c4.png)
...
This event is available only on Android >= 11. To receive it you need to use [KeyboardGestureArea](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/keyboard-gesture-area.md).

On iOS you need to specify `keyboardDismissMode="interactive"` on your `ScrollView`.

#### `onEnd`[​](/react-native-keyboard-controller/pr-preview/pr-989/docs/api/hooks/keyboard/use-keyboard-handler.md#onend "Direct link to onend")
...
![](/react-native-keyboard-controller/pr-preview/pr-989/assets/images/end-51c1da133c9105d1711f5472ef02f7dc.png)
