...
## Features[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#features "Direct link to Features")
...
## Compound Components[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#compound-components "Direct link to Compound Components")
...
### `<KeyboardToolbar.Background>`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#keyboardtoolbarbackground "Direct link to keyboardtoolbarbackground")
...
### `<KeyboardToolbar.Content>`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#keyboardtoolbarcontent "Direct link to keyboardtoolbarcontent")
...
### `<KeyboardToolbar.Prev>`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#keyboardtoolbarprev "Direct link to keyboardtoolbarprev")

#### `button`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#button "Direct link to button")
...
#### `icon`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#icon "Direct link to icon")
...
#### `onPress`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#onpress "Direct link to onpress")
...
### `<KeyboardToolbar.Next>`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#keyboardtoolbarnext "Direct link to keyboardtoolbarnext")

#### `button`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#button-1 "Direct link to button-1")
...
#### `icon`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#icon-1 "Direct link to icon-1")
...
#### `onPress`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#onpress-1 "Direct link to onpress-1")
...
### `<KeyboardToolbar.Done>`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#keyboardtoolbardone "Direct link to keyboardtoolbardone")

#### `button`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#button-2 "Direct link to button-2")
...
#### `onPress`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#onpress-2 "Direct link to onpress-2")
...
#### `text`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#text "Direct link to text")
...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#props "Direct link to Props")

### [`View Props`](https://reactnative.dev/docs/view#props)[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#view-props "Direct link to view-props")

Inherits [View Props](https://reactnative.dev/docs/view#props).

### [`KeyboardStickyViewProps`](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-sticky-view.md)[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#keyboardstickyviewprops "Direct link to keyboardstickyviewprops")

Inherits [KeyboardStickyViewProps](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-sticky-view.md).

### `insets`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#insets "Direct link to insets")
...
### `opacity`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#opacity "Direct link to opacity")
...
### `theme`[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#theme "Direct link to theme")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#example "Direct link to Example")
...
## Migration to compound component[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#migration-to-compound-component "Direct link to Migration to compound component")
...
## Limitations[​](/react-native-keyboard-controller/pr-preview/pr-1351/docs/api/components/keyboard-toolbar.md#limitations "Direct link to Limitations")
