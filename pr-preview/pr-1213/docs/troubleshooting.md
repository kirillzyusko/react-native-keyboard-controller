...
## Incompatible `kotlinVersion` and failed Android builds[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#incompatible-kotlinversion-and-failed-android-builds "Direct link to incompatible-kotlinversion-and-failed-android-builds")
...
### `react-native` or `expo` bare workflow[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#react-native-or-expo-bare-workflow "Direct link to react-native-or-expo-bare-workflow")
...
### `Expo` managed workflow[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#expo-managed-workflow "Direct link to expo-managed-workflow")
...
## Swift support[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#swift-support "Direct link to Swift support")
...
## Animations frame drops[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#animations-frame-drops "Direct link to Animations frame drops")
...
## `MutexLockWithTimeout` C++ exception[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#mutexlockwithtimeout-c-exception "Direct link to mutexlockwithtimeout-c-exception")
...
## Filename longer than 260 characters[​](/react-native-keyboard-controller/pr-preview/pr-1213/docs/troubleshooting.md#filename-longer-than-260-characters "Direct link to Filename longer than 260 characters")
