...
While `KeyboardAvoidingView` can be used in chat apps, it has [fundamental limitations](/react-native-keyboard-controller/pr-preview/pr-1646/docs/guides/building-chat-app.md#why-general-purpose-components-fall-short) for chat layouts. Use [`KeyboardChatScrollView`](/react-native-keyboard-controller/pr-preview/pr-1646/docs/api/components/keyboard-chat-scroll-view.md) for a component designed to avoid these limitations.
