...
## Methods[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#methods "Direct link to Methods")

### `setInputMode`[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#setinputmode- "Direct link to setinputmode-")
...
### `setDefaultMode`[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#setdefaultmode- "Direct link to setdefaultmode-")
...
### `dismiss`[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#dismiss "Direct link to dismiss")
...
### `isVisible`[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#isvisible "Direct link to isvisible")
...
### `state`[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#state "Direct link to state")
...
### `setFocusTo`[​](/react-native-keyboard-controller/pr-preview/pr-998/docs/api/keyboard-controller.md#setfocusto "Direct link to setfocusto")
