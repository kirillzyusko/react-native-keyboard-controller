...
## `KeyboardStickyView` vs `KeyboardExtender`[​](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-extender.md#keyboardstickyview-vs-keyboardextender "Direct link to keyboardstickyview-vs-keyboardextender")
...
## Features[​](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-extender.md#features "Direct link to Features")
...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-extender.md#props "Direct link to Props")

### `enabled`[​](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-extender.md#enabled "Direct link to enabled")
...
## Usage[​](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-extender.md#usage "Direct link to Usage")
...
## Limitations[​](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-extender.md#limitations "Direct link to Limitations")

* You can not put `TextInput` inside `KeyboardExtender`. Consider to use [KeyboardBackgroundView](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/views/keyboard-background-view.md) + [KeyboardStickyView](/react-native-keyboard-controller/pr-preview/pr-1332/docs/api/components/keyboard-sticky-view.md) instead.
