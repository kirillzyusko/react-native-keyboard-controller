...
## Process overview[​](/react-native-keyboard-controller/pr-preview/pr-1322/docs/recipes/architecture.md#process-overview "Direct link to Process overview")
...
## Design principles[​](/react-native-keyboard-controller/pr-preview/pr-1322/docs/recipes/architecture.md#design-principles "Direct link to Design principles")
...
## Why custom `KeyboardControllerView` is needed?[​](/react-native-keyboard-controller/pr-preview/pr-1322/docs/recipes/architecture.md#why-custom-keyboardcontrollerview-is-needed "Direct link to why-custom-keyboardcontrollerview-is-needed")
...
## What is the difference between `useAnimatedKeyboard` from `react-native-reanimated` and this library?[​](/react-native-keyboard-controller/pr-preview/pr-1322/docs/recipes/architecture.md#what-is-the-difference-between-useanimatedkeyboard-from-react-native-reanimated-and-this-library "Direct link to what-is-the-difference-between-useanimatedkeyboard-from-react-native-reanimated-and-this-library")
...
| Dynamically switch [`softInputMode`](/react-native-keyboard-controller/pr-preview/pr-1322/docs/api/keyboard-controller.md#setinputmode-) | ✅                                 | ❌                        |
