...
## Known issues[​](/react-native-keyboard-controller/pr-preview/pr-1370/docs/api/components/keyboard-avoiding-view.md#known-issues "Direct link to Known issues")
