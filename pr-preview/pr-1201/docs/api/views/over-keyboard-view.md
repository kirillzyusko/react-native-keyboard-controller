...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1201/docs/api/views/over-keyboard-view.md#props "Direct link to Props")

### `visible`[​](/react-native-keyboard-controller/pr-preview/pr-1201/docs/api/views/over-keyboard-view.md#visible "Direct link to visible")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1201/docs/api/views/over-keyboard-view.md#example "Direct link to Example")
