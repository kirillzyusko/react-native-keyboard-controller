...
## Why general-purpose components fall short[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#why-general-purpose-components-fall-short "Direct link to Why general-purpose components fall short")
...
## What chat apps actually need[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#what-chat-apps-actually-need "Direct link to What chat apps actually need")
...
## What is `KeyboardChatScrollView`?[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#what-is-keyboardchatscrollview "Direct link to what-is-keyboardchatscrollview")
...
## Step-by-step integration[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#step-by-step-integration "Direct link to Step-by-step integration")
...
### Basic setup with `ScrollView`[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#basic-setup-with-scrollview "Direct link to basic-setup-with-scrollview")
...
### Adding interactive dismissal[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#adding-interactive-dismissal "Direct link to Adding interactive dismissal")
...
### Accounting for bottom safe area[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#accounting-for-bottom-safe-area "Direct link to Accounting for bottom safe area")
...
### Choosing a `keyboardLiftBehavior`[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#choosing-a-keyboardliftbehavior "Direct link to choosing-a-keyboardliftbehavior")
...
### Freezing content for custom input views[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#freezing-content-for-custom-input-views "Direct link to Freezing content for custom input views")
...
### Handling a growing multiline input[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#handling-a-growing-multiline-input "Direct link to Handling a growing multiline input")
...
## Using with virtualized lists[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#using-with-virtualized-lists "Direct link to Using with virtualized lists")
...
### Creating a scroll wrapper[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#creating-a-scroll-wrapper "Direct link to Creating a scroll wrapper")
...
### Plugging into `FlashList`[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#plugging-into-flashlist "Direct link to plugging-into-flashlist")
...
### Plugging into `FlatList` / `LegendList`[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#plugging-into-flatlist--legendlist "Direct link to plugging-into-flatlist--legendlist")
...
### Handling the `inverted` prop[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#handling-the-inverted-prop "Direct link to handling-the-inverted-prop")
...
## Complete example[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#complete-example "Direct link to Complete example")
...
## API reference[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#api-reference "Direct link to API reference")

For the full list of props and design principles, see the [`KeyboardChatScrollView` API reference](/react-native-keyboard-controller/pr-preview/pr-1362/docs/api/components/keyboard-chat-scroll-view.md).

## Troubleshooting[​](/react-native-keyboard-controller/pr-preview/pr-1362/docs/guides/building-chat-app.md#troubleshooting "Direct link to Troubleshooting")

Check troubleshooting section first

If you encounter any issues with `KeyboardChatScrollView`, please check the [Troubleshooting section](/react-native-keyboard-controller/pr-preview/pr-1362/docs/api/components/keyboard-chat-scroll-view.md#troubleshooting) first before reporting a bug. If you're still having trouble, feel free to [open an issue](https://github.com/kirillzyusko/react-native-keyboard-controller/issues/new) on GitHub.
