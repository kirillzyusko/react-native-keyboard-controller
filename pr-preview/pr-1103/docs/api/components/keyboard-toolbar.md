...
## Features[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#features "Direct link to Features")
...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#props "Direct link to Props")

### [`View Props`](https://reactnative.dev/docs/view#props)[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#view-props "Direct link to view-props")

Inherits [View Props](https://reactnative.dev/docs/view#props).

### [`KeyboardStickyViewProps`](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-sticky-view.md)[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#keyboardstickyviewprops "Direct link to keyboardstickyviewprops")

Inherits [KeyboardStickyViewProps](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-sticky-view.md).

### `button`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#button "Direct link to button")
...
### `blur`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#blur "Direct link to blur")
...
### `content`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#content "Direct link to content")
...
### `doneText`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#donetext "Direct link to donetext")
...
### `icon`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#icon "Direct link to icon")
...
### `insets`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#insets "Direct link to insets")
...
### `onDoneCallback`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#ondonecallback "Direct link to ondonecallback")
...
### `onNextCallback`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#onnextcallback "Direct link to onnextcallback")
...
### `onPrevCallback`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#onprevcallback "Direct link to onprevcallback")
...
### `opacity`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#opacity "Direct link to opacity")
...
### `showArrows`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#showarrows "Direct link to showarrows")
...
### `theme`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#theme "Direct link to theme")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#example "Direct link to Example")
...
## Limitations[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/components/keyboard-toolbar.md#limitations "Direct link to Limitations")
