...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#props "Direct link to Props")

### `offset`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#offset "Direct link to offset")

Extra distance to the keyboard. Default is `0`.

### `interpolator`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#interpolator- "Direct link to interpolator-")
...
### `showOnSwipeUp`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#showonswipeup- "Direct link to showonswipeup-")
...
### `enableSwipeToDismiss`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#enableswipetodismiss- "Direct link to enableswipetodismiss-")
...
### `textInputNativeID`[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#textinputnativeid- "Direct link to textinputnativeid-")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1103/docs/api/views/keyboard-gesture-area.md#example "Direct link to Example")
