...
## Comparison[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#comparison "Direct link to Comparison")
...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#props "Direct link to Props")

### [`ScrollView Props`](https://reactnative.dev/docs/scrollview#props)[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#scrollview-props "Direct link to scrollview-props")

Inherits [ScrollView Props](https://reactnative.dev/docs/scrollview#props).

### `ScrollViewComponent`[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#scrollviewcomponent "Direct link to scrollviewcomponent")
...
### `bottomOffset`[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#bottomoffset "Direct link to bottomoffset")
...
### `disableScrollOnKeyboardHide`[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#disablescrollonkeyboardhide "Direct link to disablescrollonkeyboardhide")

Prevents automatic scrolling of the `ScrollView` when the keyboard gets hidden, maintaining the current screen position. Default is `false`.

### `enabled`[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#enabled "Direct link to enabled")

A boolean prop indicating whether `KeyboardAwareScrollView` is enabled or disabled. Default is `true`.

### `extraKeyboardSpace`[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#extrakeyboardspace "Direct link to extrakeyboardspace")
...
## Integration with 3rd party components[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#integration-with-3rd-party-components "Direct link to Integration with 3rd party components")

### `FlatList`/`FlashList`/`SectionList` etc.[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#flatlistflashlistsectionlist-etc "Direct link to flatlistflashlistsectionlist-etc")
...
### `@gorhom/bottom-sheet`[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#gorhombottom-sheet "Direct link to gorhombottom-sheet")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#example "Direct link to Example")
...
## Known issues[​](/react-native-keyboard-controller/pr-preview/pr-1018/docs/api/components/keyboard-aware-scroll-view.md#known-issues "Direct link to Known issues")
