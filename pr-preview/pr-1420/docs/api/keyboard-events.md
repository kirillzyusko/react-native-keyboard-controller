...
## Event structure[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/keyboard-events.md#event-structure "Direct link to Event structure")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/keyboard-events.md#example "Direct link to Example")
