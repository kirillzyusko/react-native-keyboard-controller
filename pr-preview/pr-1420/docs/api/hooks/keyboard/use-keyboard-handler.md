...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#example "Direct link to Example")
...
### Event structure[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#event-structure "Direct link to Event structure")
...
### Handlers[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#handlers "Direct link to Handlers")

#### `onStart`[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#onstart "Direct link to onstart")
...
![](/react-native-keyboard-controller/pr-preview/pr-1420/assets/images/start-305c203ddbdc76ff90b5615908259a9e.png)
...
#### `onMove`[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#onmove "Direct link to onmove")
...
![](/react-native-keyboard-controller/pr-preview/pr-1420/assets/images/move-399f00093385ef653ca2bf8b5b3904ff.png)
...
#### `onInteractive`[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#oninteractive "Direct link to oninteractive")
...
![](/react-native-keyboard-controller/pr-preview/pr-1420/assets/images/interactive-4d1b89d0c133111eb4d18a2e7ffeab9b.png)
...
This event is available only on Android >= 11. To receive it you need to use [KeyboardGestureArea](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/views/keyboard-gesture-area.md).

On iOS you need to specify `keyboardDismissMode="interactive"` on your `ScrollView`.

#### `onEnd`[​](/react-native-keyboard-controller/pr-preview/pr-1420/docs/api/hooks/keyboard/use-keyboard-handler.md#onend "Direct link to onend")
...
![](/react-native-keyboard-controller/pr-preview/pr-1420/assets/images/end-59a0fe1530f5a2d63d2c744b86e87ffe.png)
