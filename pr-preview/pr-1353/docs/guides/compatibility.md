...
## `react-native`[​](/react-native-keyboard-controller/pr-preview/pr-1353/docs/guides/compatibility.md#react-native "Direct link to react-native")

Below you can find an information about compatibility with `react-native` package per different architectures.

### Fabric (new) architecture[​](/react-native-keyboard-controller/pr-preview/pr-1353/docs/guides/compatibility.md#fabric-new-architecture "Direct link to Fabric (new) architecture")
...
### Paper (old) architecture[​](/react-native-keyboard-controller/pr-preview/pr-1353/docs/guides/compatibility.md#paper-old-architecture "Direct link to Paper (old) architecture")
...
## `react-native-reanimated`[​](/react-native-keyboard-controller/pr-preview/pr-1353/docs/guides/compatibility.md#react-native-reanimated "Direct link to react-native-reanimated")
...
## Third-party libraries compatibility[​](/react-native-keyboard-controller/pr-preview/pr-1353/docs/guides/compatibility.md#third-party-libraries-compatibility "Direct link to Third-party libraries compatibility")
