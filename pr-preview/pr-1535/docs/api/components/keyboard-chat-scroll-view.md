...
[](/react-native-keyboard-controller/pr-preview/pr-1535/video/keyboard-chat-scroll-view/always.mp4)

## Props[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#props "Direct link to Props")

### [`ScrollView Props`](https://reactnative.dev/docs/scrollview#props)[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#scrollview-props "Direct link to scrollview-props")

Inherits all [ScrollView Props](https://reactnative.dev/docs/scrollview#props).

### `ScrollViewComponent`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#scrollviewcomponent "Direct link to scrollviewcomponent")
...
### `freeze`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#freeze "Direct link to freeze")
...
### `inverted`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#inverted "Direct link to inverted")
...
### `keyboardLiftBehavior`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#keyboardliftbehavior "Direct link to keyboardliftbehavior")

Controls how the chat content responds when the keyboard appears. Defaults to `"always"`.

#### `always`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#always "Direct link to always")
...
#### `whenAtEnd`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#whenatend "Direct link to whenatend")
...
[](/react-native-keyboard-controller/pr-preview/pr-1535/video/keyboard-chat-scroll-view/when-at-end.mp4)

#### `persistent`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#persistent "Direct link to persistent")
...
[](/react-native-keyboard-controller/pr-preview/pr-1535/video/keyboard-chat-scroll-view/persistent.mp4)

#### `never`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#never "Direct link to never")
...
[](/react-native-keyboard-controller/pr-preview/pr-1535/video/keyboard-chat-scroll-view/never.mp4)

### `offset`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#offset "Direct link to offset")
...
### `extraContentPadding`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#extracontentpadding "Direct link to extracontentpadding")
...
### `applyWorkaroundForContentInsetHitTestBug`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#applyworkaroundforcontentinsethittestbug "Direct link to applyworkaroundforcontentinsethittestbug")
...
### `blankSpace`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#blankspace "Direct link to blankspace")
...
#### When `blankSpace >= keyboard + extraContentPadding`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#when-blankspace--keyboard--extracontentpadding "Direct link to when-blankspace--keyboard--extracontentpadding")
...
[](/react-native-keyboard-controller/pr-preview/pr-1535/video/keyboard-chat-scroll-view/blankSpaceGreaterThan.mp4)

#### When `blankSpace < keyboard + extraContentPadding`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#when-blankspace--keyboard--extracontentpadding-1 "Direct link to when-blankspace--keyboard--extracontentpadding-1")

Content moves, but only by the **excess amount** beyond the minimum floor.

[](/react-native-keyboard-controller/pr-preview/pr-1535/video/keyboard-chat-scroll-view/blankSpaceLessThan.mp4)
...
### `onContentInsetChange`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#oncontentinsetchange "Direct link to oncontentinsetchange")
...
### `onEndVisible`[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#onendvisible "Direct link to onendvisible")
...
## Usage with virtualized lists[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#usage-with-virtualized-lists "Direct link to Usage with virtualized lists")
...
## Example[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#example "Direct link to Example")

<!-- -->

## Design principles[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#design-principles "Direct link to Design principles")
...
### Extending scroll range[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#extending-scroll-range "Direct link to Extending scroll range")
...
### Adjusting scroll position[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#adjusting-scroll-position "Direct link to Adjusting scroll position")

The second step is to adjust the scroll position. This is handled differently on iOS and Android.

#### iOS[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#ios "Direct link to iOS")
...
#### Android[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#android "Direct link to Android")

On Android we adjust the scroll position inside the [`onMove`](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/hooks/keyboard/use-keyboard-handler.md#onmove) handler via the [`scrollTo`](https://docs.swmansion.com/react-native-reanimated/docs/scroll/scrollTo/) method on the UI thread from a worklet.

## Troubleshooting[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#troubleshooting "Direct link to Troubleshooting")

### De-synchronized Android animation (new arch only)[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#de-synchronized-android-animation-new-arch-only "Direct link to De-synchronized Android animation (new arch only)")
...
### Missing animations on iOS (new arch only)[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#missing-animations-on-ios-new-arch-only "Direct link to Missing animations on iOS (new arch only)")
...
### `scrollToEnd` doesn't scroll to the correct position when keyboard is open[​](/react-native-keyboard-controller/pr-preview/pr-1535/docs/api/components/keyboard-chat-scroll-view.md#scrolltoend-doesnt-scroll-to-the-correct-position-when-keyboard-is-open "Direct link to scrolltoend-doesnt-scroll-to-the-correct-position-when-keyboard-is-open")
