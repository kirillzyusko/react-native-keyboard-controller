...
## Key Features[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#key-features "Direct link to Key Features")
...
## When to Use[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#when-to-use "Direct link to When to Use")
...
## Props[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#props "Direct link to Props")
...
## Usage[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#usage "Direct link to Usage")

### Basic[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#basic "Direct link to Basic")
...
### Shared-surface transition (advanced)[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#shared-surface-transition-advanced "Direct link to Shared-surface transition (advanced)")
...
## See also[​](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/views/keyboard-background-view.md#see-also "Direct link to See also")

* [`KeyboardStickyView`](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/components/keyboard-sticky-view.md) – affixes content to the keyboard’s frame.
* [`useReanimatedKeyboardAnimation`](/react-native-keyboard-controller/pr-preview/pr-1534/docs/api/hooks/keyboard/use-reanimated-keyboard-animation.md) – drive your own animations with native‑driven progress values.
