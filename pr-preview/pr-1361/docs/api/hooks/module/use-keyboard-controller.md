...
Consider to use [KeyboardAvoidingView](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/components/keyboard-avoiding-view.md) which also resize the window, but does it with beautiful animated transitions that makes your interactions with app smooth and pleasant.

## Example[​](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/hooks/module/use-keyboard-controller.md#example "Direct link to Example")
...
## Using with class component[​](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/hooks/module/use-keyboard-controller.md#using-with-class-component "Direct link to Using with class component")
