...
## Returned values[​](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/hooks/input/use-reanimated-focused-input.md#returned-values "Direct link to Returned values")

### `input`[​](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/hooks/input/use-reanimated-focused-input.md#input "Direct link to input")
...
### `update`[​](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/hooks/input/use-reanimated-focused-input.md#update "Direct link to update")

To update the focused input, use `update` function. Thus you can query the position on demand from JS thread.

## Example[​](/react-native-keyboard-controller/pr-preview/pr-1361/docs/api/hooks/input/use-reanimated-focused-input.md#example "Direct link to Example")
